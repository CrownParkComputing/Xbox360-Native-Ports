...
macro(rexglue_setup_target target_name)
    if(REXGLUE_ENTRYPOINT_GENERATED_SOURCES)
        ...
        rexglue_apply_recomp_settings(${target_name}_recomp
            "${REXGLUE_ENTRYPOINT_INCLUDE_DIR}/ridgeracerunbounded_pch.h")
        # Only when codegen exists to depend on - see the cross-compiling note below.
        if(NOT CMAKE_CROSSCOMPILING)
            add_dependencies(${target_name}_recomp ridgeracerunbounded_codegen)
        endif()
    ...
    if(NOT CMAKE_CROSSCOMPILING)
        add_dependencies(${target_name} ridgeracerunbounded_codegen)
    endif()
...
# changes. Build it alone with 'cmake --build . --target ridgeracerunbounded_codegen'.
...
add_custom_command(
    OUTPUT "${CMAKE_CURRENT_SOURCE_DIR}/generated/default/codegen.build.stamp"
           ${REXGLUE_ENTRYPOINT_GENERATED_SOURCES}
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/ridgeracerunbounded_manifest.toml
    DEPFILE "${CMAKE_CURRENT_SOURCE_DIR}/generated/default/codegen.d"
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for ridgeracerunbounded"
    VERBATIM
)
add_custom_target(ridgeracerunbounded_codegen
