...
#define REX_IMAGE_BASE 0x98000000ull
#define REX_IMAGE_SIZE 0x13D000ull
#define REX_CODE_BASE 0x9803B000ull
#define REX_CODE_SIZE 0xEBCECull
...
#else
#define DEFINE_REX_FUNC(name)                                       \
  extern "C" __attribute__((weak, alias("__imp__" #name)))          \
      __attribute__((noinline)) REX_FUNC(name);                      \
  REX_EXTERN(__imp__##name)
#endif
#endif
